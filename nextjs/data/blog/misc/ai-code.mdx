...
**2025-02-21 Update:** Our shared Google account strategy (used for months across multiple IPs) has now been officially restricted.
...
**Endpoint:** [https://api.deerapi.com](https://api.deerapi.com)  
**API Key:** `sk-xxxxxx`
